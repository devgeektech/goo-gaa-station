...
export const ROUTES = [
  ...
  { method: 'GET', path: '/api/v1/admin/app-settings', auth: true, description: 'Get app settings (admin): deliveryFee, taxPercent' },
  { method: 'PATCH', path: '/api/v1/admin/app-settings', auth: true, description: 'Update app settings (admin): deliveryFee >= 0, taxPercent 0-100' },
