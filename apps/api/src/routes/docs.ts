...
export const ROUTES = [
  ...
  { method: 'GET', path: '/api/v1/app/customer/addresses', auth: true, description: 'Get addresses; data.addresses each has preferred boolean; first saved address is preferred; ordering or PUT can change preferred' },
