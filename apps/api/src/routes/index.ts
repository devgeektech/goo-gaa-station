...
import driverSetupRoutes from './driver/driverSetup.routes';
...
import vendorWalletRoutes from './vendor/wallet.routes';
import vendorNotificationRoutes from './vendor/notifications.routes';
...
import appSettingsAdminRoutes from './admin/appSettingsAdmin.routes';
import bannerAdminRoutes from './admin/bannerAdmin.routes';
import customerProfileRoutes from './app/customerProfile.routes';
import customerNotificationsRoutes from './app/customerNotifications.routes';
...
import bannerAppRoutes from './app/bannerApp.routes';
...
v1Router.use('/auth/driver', driverAuthRoutes);
...
v1Router.use('/driver/earnings', authDriver, driverEarningsRoutes);
v1Router.use('/driver/dashboard', authDriver, driverDashboardRoutes);
...
v1Router.use('/vendor/notifications', authVendor, requireApproved, vendorNotificationRoutes);
...
v1Router.use('/admin/app-settings', appSettingsAdminRoutes);
v1Router.use('/admin/banners', bannerAdminRoutes);
v1Router.use('/app/customer', customerProfileRoutes);
v1Router.use('/app/customer/notifications', authenticateJWT, enforceCustomerAccount, requireRole('user'), customerNotificationsRoutes);
...
v1Router.use('/app/banners', bannerAppRoutes);
